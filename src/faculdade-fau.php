...
$resultado = mysqli_query($conn, "SELECT faculdade_nomecurto, faculdade_nomelongo, descritivo, telefone, email, predio_numero, predio_nome from faculdades where id = '$pageid'") or die("Não foi possível executar a SQL: ".mysqli_error($conn));
if($resultado){
